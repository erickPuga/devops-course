...
-- ============================================
-- SEED DATA (Opcional - Comentado por defecto)
-- ============================================
-- Descomentar solo si necesitas datos de prueba
/*
INSERT INTO public.users (email, password_hash, name, daily_calorie_goal) VALUES
('demo@example.com', '$2b$10$...', 'Demo User', 2500);
*/
